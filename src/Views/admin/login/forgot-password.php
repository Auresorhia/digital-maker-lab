...
<head>
    ...
    <title>Mot de passe oublié - Digital Maker Lab</title>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .btn-login { width: 100%; border-radius: 16px; }
...
<body style="background-image: url('<?= $basePath ?>/assets/images/home/backgrounds/FOND.svg');">
    ...
    <div class="login-wrapper">
        ...
        <div class="login-badge">Mot de passe oublié</div>

        <p class="intro-text">Saisissez votre adresse email. Si un compte y est associé, vous recevrez un code à 4 chiffres.</p>
