...
<head>
    ...
    <title>Code de vérification - Digital Maker Lab</title>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .intro-text { color: #777; font-size: 15px; text-align: center; line-height: 1.55; max-width: 420px; }
        ...
        .login-links { display: flex; flex-direction: column; align-items: center; gap: 12px; margin-top: 24px; }
        .login-links a { color: var(--color-blue); font-size: 15px; font-weight: 600; text-decoration: underline; text-underline-offset: 3px; transition: color var(--transition-fast); }
        .login-links a:hover { color: var(--color-purple); }
...
<body style="background-image: url('<?= $basePath ?>/assets/images/home/backgrounds/FOND.svg');">
    ...
    <div class="login-wrapper">
        ...
        <div class="login-badge">Code à 4 chiffres</div>

        <p class="intro-text">Saisissez le code à 4 chiffres reçu par email.</p>
