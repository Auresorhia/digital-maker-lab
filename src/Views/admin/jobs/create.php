        ...
        <main>
            ...
            <form action="" class="form-container">
                <div class="form-label-input-container">
                    ...
                    <input type="text" id="input-main-title" class="input" placeholder="Le métier de consultant SEO">
                </div>
                <div class="form-label-input-container">
                    <label for="input-icon" class="input-title">Icon de spécialité</label>
                    <input type="text" id="input-icon" class="input" placeholder="***** À modifier *****" disabled>
                </div>
                <div class="form-label-input-container">
                    <label for="input-explainer-title" class="input-title">Titre de la partie explainer</label>
                    <input type="text" id="input-explainer-title" class="input" placeholder="Le métier de consultant SEO, c’est quoi ?">
                </div>
                <div class="form-label-input-container">
                    <label for="input-explainer-text" class="input-title">Texte de la partie explainer</label>
                    <input type="text" id="input-explainer-text" class="input" placeholder="Le métier de consultant SEO, c'est bla-bla-bla">
                </div>
                <div class="form-label-input-container">
                    <label for="input-title-pro" class="input-title">Titre de l'interview du professionnel</label>
                    <input type="text" id="input-title-pro" class="input" placeholder="Tes missions en tant que consultant SEO">
                </div>
                <div class="form-label-input-container">
                    <label for="input-main-title" class="input-title">Lien de l'interview du professionnel</label>
                    <input type="text" id="input-main-title" class="input" placeholder="***** À modifier *****" disabled>
                </div>
                <div class="form-label-input-container">
                    <label for="input-qualities-title" class="input-title">Titre de la section sur les qualités</label>
                    <input type="text" id="input-qualities-title" class="input" placeholder="Les compétences indispensables pour être consultant SEO">
                </div>
                <div class="form-label-input-container">
                    <label for="input-quality-number-one" class="input-title">Titre de la qualité numéro une</label>
                    <input type="text" id="input-quality-number-one" class="input" placeholder="Les qualités incontournables">
                </div>
                <div class="form-label-input-container">
                    <label for="input-quality-number-one-text" class="input-title">Texte de la qualité numéro une</label>
                    <input type="text" id="input-quality-number-one-text" class="input" placeholder="Savoir-être">
                </div>
                <div class="form-label-input-container">
                    <label for="input-quality-number-two" class="input-title">Titre de la qualité numéro deux</label>
                    <input type="text" id="input-quality-number-two" class="input" placeholder="Les compétences techniques">
                </div>
                <div class="form-label-input-container">
                    <label for="input-quality-number-two-text" class="input-title">Texte de la qualité numéro deux</label>
                    <input type="text" id="input-quality-number-two-text" class="input" placeholder="Savoir-faire">
                </div>
                <div class="form-label-input-container">
                    <label for="input-quality-number-three" class="input-title">Titre de la qualité numéro trois</label>
                    <input type="text" id="input-quality-number-three" class="input" placeholder="Les outils que tu vas utiliser">
                </div>
                <div class="form-label-input-container">
                    <label for="input-quality-number-three-text" class="input-title">Texte de la qualité numéro trois</label>
                    <input type="text" id="input-quality-number-three-text" class="input" placeholder="xemple d’outils (Semrush, etc)">
                </div>
                <div class="form-label-input-container">
                    <label for="input-working-site-title" class="input-title">Titre de la section du lieu de travail</label>
                    <input type="text" id="input-working-site-title" class="input" placeholder="Où travaille un consultant SEO ?">
                </div>
                <div class="form-label-input-container">
                    <label for="input-working-site-text" class="input-title">Texte de la section du lieu de travail</label>
                    <input type="text" id="input-working-site-text" class="input" placeholder="Sur Mars">
                </div>
                <div class="form-label-input-container">
                    <label for="input-student-video-title" class="input-title">Titre de la vidéo sur l'étudiant</label>
                    <input type="text" id="input-student-video-title" class="input" placeholder="Où se former pour devenir consultant SEO ?">
                </div>
                <div class="form-label-input-container">
                    <label for="input-main-title" class="input-title">Lien de la vidéo sur l'étudiant</label>
                    <input type="text" id="input-main-title" class="input" placeholder="***** À modifier *****" disabled>
                </div>
                <div class="form-label-input-container">
                    <label for="input-money-title" class="input-title">Titre de la section sur la rémunération</label>
                    <input type="text" id="input-money-title" class="input" placeholder="Combien gagne un consultant SEO ?">
                </div>
                <div class="form-label-input-container">
                    <label for="input-money-text" class="input-title">Texte de la section sur la rémunération</label>
                    <input type="text" id="input-money-text" class="input" placeholder="Argentttt">
                </div>
                <div class="form-label-input-container">
                    <label for="input-career-development-title" class="input-title">Titre de la section sur l'évolution de carrière</label>
                    <input type="text" id="input-career-development-title" class="input" placeholder="Quelles sont les évolutions possibles après quelques années d’expérience ?">
                </div>
