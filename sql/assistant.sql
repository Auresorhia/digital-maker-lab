-- ============================================
-- Fichier SQL — Fonctionnalité "Assistant IA"
-- Tickets : #29 (table) + #30 (données)
-- Date : 2026-06-16
-- ============================================
--
-- TICKET #29 — Création de la table
-- (IF NOT EXISTS = sécurité si déjà créée)
-- ============================================
...
-- ============================================
-- TICKET #30 — Insertion des données
-- 8 métiers × 3 applications chacun
-- ============================================
