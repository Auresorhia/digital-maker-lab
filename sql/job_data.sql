...
INSERT INTO `job` (`id_job`, `job_name`, `specialty_id`, `created_at`, `updated_at`) VALUES
(1, 'Créateur d\'entreprise',  1, NOW(), NOW()),
(2, 'Responsable CRM',         1, NOW(), NOW()),
(3, 'Consultant SEO',          1, NOW(), NOW()),
(4, 'Game Designer',           1, NOW(), NOW()),
(5, 'Développeur Web',         2, NOW(), NOW()),
(6, 'Community Manager',       1, NOW(), NOW()),
(7, 'Vidéaste',                1, NOW(), NOW()),
(8, 'Graphiste',               1, NOW(), NOW());

SET FOREIGN_KEY_CHECKS = 1;

DELETE FROM `assistant_ia_apps`;
